...
<div class="card mb-3 a" style="max-width: 540px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="img/music.png" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        ...
        <p class="fw-bold"><small class="fw-bold">300 $mx</small></p>
<button  class="btn btn-outline-primary" name="pagar">Pagar</button>
      </div>
    </div>
  </div>
</div>
