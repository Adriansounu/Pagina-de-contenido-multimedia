...
<div class="card mb-3 a" style="max-width: 540px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="img/HBO.jpeg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        ...
        <p class="fw-bold"><small class="fw-bold">450 $mx</small></p>
<button  class="btn btn-outline-dark" name="pagar">Pagar</button>
      </div>
    </div>
  </div>
</div>
