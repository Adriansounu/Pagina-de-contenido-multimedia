...
<body class="bg-black muli">
    <nav class="w-100pc flex flex-column md-flex-row md-px-10 py-5 bg-black">
        <div class="flex justify-between">
            <a href="index.php" class="flex items-center p-2 mr-4 no-underline">
                <img class="max-h-l2 w-auto" src="assets/images/logo2.png" />
            </a>
        ...
        <div id="nav-items" class="hidden flex sm-w-100pc flex-column md-flex md-flex-row md-justify-end items-center">
            <a href="#str" class="fs-s1 mx-3 py-3 indigo no-underline hover-underline">¿Qué es Streaming?</a>
            <a href="#car" class="fs-s1 mx-3 py-3 indigo no-underline hover-underline">Contenidos en Streaming</a>
            <a href="#car2" class="fs-s1 mx-3 py-3 indigo no-underline hover-underline">¿Cuáles son los requisitos para tener Streaming?</a>
            <a href="#pf" class="fs-s1 mx-3 py-3 indigo no-underline hover-underline">Plataformas de Streaming disponibles</a>
            <a href="registro.php" class="button bg-white black fw-600 no-underline mx-5">Crear Cuenta &nbsp <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-plus" viewBox="0 0 16 16">
  <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H1s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C9.516 10.68 8.289 10 6 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
  <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/>
</svg></a>
            <a href="login.php" class="button bg-white black fw-600 
            no-underline mx-5">Iniciar Sesion &nbsp <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
  <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
    ...
    <!-- hero section -->
    <section id="home" class="min-h-100vh flex justify-start items-center">s
        <div class="mx-5 md-mx-l5">
            <div class="inline-block br-round bg-indigo-30 indigo-lightest p-2 fs-s2 mb-5">
                <div class="inline-block bg-indigo indigo-lightest br-round px-3 py-1 mr-3 fs-s3">Conoce un nuevo mundo</div>
                Nuestro servicio de streaming es unico
            </div>
            <div>
                <h1 class="white fs-l3 lh-2 md-fs-xl1 md-lh-1 fw-900 ">SAS TV <br />Un nuevo mundo a tus manos</h1>
                ...
                <div class="br-8 mt-10 inline-flex">
                    ...
                    <button
                        class="button-lg bg-indigo-lightest-20 indigo-lightest focus-white fw-300 fs-s3 mr-0 br-l-0">Empieza esta experiencia
                        </button>
                </div>
                <div class="white opacity-20 fs-s3 mt-3">No Pedimos informacion Bancaria</span>
            </div>
        </div>
    </section>
<section id="str">
   <center><h2 class="white fs-l3 fw-900 lh-1">Streaming</h2></center> 
</section>
    <!-- features -->
    <section id="features" class="p-10 md-p-l5">
        <div class="flex flex-column md-flex-row mx-auto">
            <div class="w-100pc md-w-40pc">
                <div class="br-8 p-5 m-5">
                    <div class="flex justify-center items-center bg-indigo-lightest-10 white w-l5 h-l5 br-round mb-5"><i
                            data-feather="grid" class="w-l5"></i></div>
                    <h4 class="white fw-600 fs-m3 mb-5">¿Que es?</h4>
                    <div class="indigo-lightest fw-600 fs-m1 lh-3 opacity-50">Es un tipo de tecnología multimedia que envía contenidos de vídeo y audio a su dispositivo conectado a Internet.</div>
                    <a href="https://www.avast.com/es-es/c-what-is-streaming#:~:text=El%20streaming%20es%20un%20tipo,a%20los%20horarios%20del%20proveedor."
                        class="mt-5 button bg-indigo-lightest-10 fs-s3 white no-underline hover-opacity-100 hover-scale-up-1 ease-300">Leer mas</a>
                </div>
            </div>
            <div class="w-100pc md-w-40pc">
                <div class="br-8 p-5 m-5">
                    <div class="flex justify-center items-center bg-indigo-lightest-10 white w-l5 h-l5 br-round mb-5"><i
                            data-feather="tv" class="w-l5"></i></div>
                    <h4 class="white fw-600 fs-m3 mb-5">¿Para que sirve?</h4>
                    <div class="indigo-lightest fw-600 fs-m1 opacity-50"> Esto le permite acceder a contenidos (TV, películas, música, pódcast) en cualquier momento que lo desee, en un PC o un móvil, sin someterse a los horarios del proveedor.</div>
                    <a href="https://www.avast.com/es-es/c-what-is-streaming#:~:text=El%20streaming%20es%20un%20tipo,a%20los%20horarios%20del%20proveedor."
                        class="mt-5 button bg-indigo-lightest-10 fs-s3 white no-underline hover-opacity-100 hover-scale-up-1 ease-300">Leer mas</a>
                </div>
            </div>
            <div class="w-100pc md-w-40pc">
                <div class="br-8 p-5 m-5">
                    <div class="flex justify-center items-center bg-indigo-lightest-10 white w-l5 h-l5 br-round mb-5"><i
                            data-feather="globe" class="w-l5"></i></div>
                    <h4 class="white fw-600 fs-m3 mb-5">¿Como funciona?</h4>
                    <div class="indigo-lightest fw-600 fs-m1 opacity-50">No hay un solo canal abierto entre la fuente y el destino. En lugar de ello, la fuente agrupa los datos en pequeños paquetes y los envía a través de Internet. Es similar a lo que ocurre cuando envía un correo electrónico o publica algo en un sitio web.</div>
                    <a href="https://www.avast.com/es-es/c-what-is-streaming#:~:text=El%20streaming%20es%20un%20tipo,a%20los%20horarios%20del%20proveedor."
                        class="mt-5 button bg-indigo-lightest-10 fs-s3 white no-underline hover-opacity-100 hover-scale-up-1 ease-300">Leer mas</a>
                </div>
            </div>
    ...
    <section id="car">
        <center><h2 class="white fs-l3 fw-900 lh-1">Contenidos en Streaming</h2></center> 
     </section>
     <br>
     <br>
     <br>
     <br>
    <!-- slider -->
    <section id="car" class="relative bg-indigo-lightest-10">
        <div id="slider-1">
            <div class="p-10 md-p-l10 flex justify-center items-center flex-column text-center">
                <h2 class="white fs-l2 fw-900">Música</h2>
                <p class="indigo-lightest fw-600 fs-m1 opacity-30 my-5">Las plataformas más populares son Spotify, Apple Music, Youtube, Amazon Music y Tidal.</p>
                <img src="img/Spo.png" class="d-block w-100" style="width: 130px; height: 130px;" alt="alternative">
                <a href="#" class="button-md bg-indigo white fs-s3 br-4 black fw-600 no-underline m-5">Subscribirse</a>
            </div>
            <div class="p-10 md-p-l10 flex justify-center items-center flex-column text-center">
                <h2 class="white fs-l3 fw-900">Películas, series y documentales</h2>
                <p class="indigo-lightest fw-600 fs-m1 opacity-30 my-5">Las mejores plataformas para ver este contenido son HBO, Disney+, Netflix, Star+ y Amazon Prime Video. </p>
                <img src="img/si.jpg" class="d-block w-100" style="width: 130px; height: 130px;" alt="alternative">
                <a href="#" class="button-md bg-indigo white fs-s3 br-4 black fw-600 no-underline m-5">Subscribirse</a>

            </div>
            <div class="p-10 md-p-l10 flex justify-center items-center flex-column text-center">
                <h2 class="white fs-l3 fw-900">Podcast</h2>
                <p class="indigo-lightest fw-600 fs-m1 opacity-30 my-5">Spotify, iTunes e Ivoox son las plataformas más populares para este tipo de contenido.</p>
                <img src="img/sas.jpg" class="d-block w-100" style="width: 130px; height: 130px;" alt="alternative">
                <a href="#" class="button-md bg-indigo white fs-s3 br-4 black fw-600 no-underline m-5">Suscribirse</a>
            </div>
            <div class="p-10 md-p-l10 flex justify-center items-center flex-column text-center">
                <h2 class="white fs-l3 fw-900">Juegos</h2>
                <p class="indigo-lightest fw-600 fs-m1 opacity-30 my-5">La plataforma más conocida para ver a usuarios jugar en streaming es Twitch. Sin embargo, en esta plataforma también podemos encontrar contenido muy diverso como entrevistas o contenido sobre el estilo de vida. </p>
                <img src="img/T.png" class="d-block w-100" style="width: 130px; height: 130px;" alt="alternative">
                <a href="#" class="button-md bg-indigo white fs-s3 br-4 black fw-600 no-underline m-5">Suscribirse</a>
            </div>
    ...
    <br>
    <section id="car2">
        <center><h2 class="white fs-l3 fw-900 lh-1">¿Cuáles son los requisitos para tener Streaming?</h2></center> 
     </section>
    <!-- product options -->
            ...
            <div class="w-100pc md-w-50pc">
                <div class="br-8 p-5 m-5 bg-indigo-lightest-10 pointer hover-scale-up-1 ease-300">
                    <div class="inline-block bg-indigo indigo-lightest br-3 px-4 py-1 mb-10 fs-s4 uppercase">
                        individual</div>
                    <div class="indigo-lightest fw-600 fs-m1">Requisito 1 <span class="opacity-30"> Conexión a internet inalámbrico, alámbrico o disponer de datos en el celular o tablet.</span> </div>
                    <a href="#" class="mt-10 button bg-black fs-s3 white no-underline">Leer mas</a>
                </div>
            </div>
            <div class="w-100pc md-w-50pc">
                <div class="br-8 p-5 m-5 bg-indigo-lightest-10  pointer hover-scale-up-1 ease-300">
                    <div class="inline-block bg-indigo indigo-lightest br-3 px-4 py-1 mb-10 fs-s4 uppercase">
                        team</div>
                    <div class="indigo-lightest fw-600 fs-m1">Requisito 2 <span class="opacity-30"> Un dispositivo que pueda conectarse a internet, puede ser un celular, computadora, tablet o un televisor inteligente.</span> </div>
                    <a href="#" class="mt-10 button bg-black fs-s3 white no-underline">Leer mas</a>
        ...
        <div class="flex flex-column md-flex-row md-w-80pc mx-auto">
            <div class="w-100pc md-w-50pc">
                <div class="br-8 p-5 m-5 bg-indigo-lightest-10 pointer hover-scale-up-1 ease-300">
                    <div class="inline-block bg-indigo indigo-lightest br-3 px-4 py-1 mb-10 fs-s4 uppercase">
                        individual</div>
                    <div class="indigo-lightest fw-600 fs-m1">Requisito 3 <span class="opacity-30">
                        Suscripción a la plataforma de streaming que se desee consumir</span> </div>
                    <a href="#" class="mt-10 button bg-black fs-s3 white no-underline">Leer mas</a>
                </div>
            </div>
    ...
    <section id="pf">
        <div class="p-10 flex flex-wrap">
            <div class="w-100pc md-w-50pc">
                <div class="p-5">
                    <h4 class="white fw-800 fs-l3 mb-5">Plataformas streaming</h4>
                    <div class="indigo-lightest fw-600 fs-m1 opacity-50">Algunas plataformas se pueden contratar junto con un paquete de internet o celular o por si solas. 
                        En el caso de contratar solo la plataforma de streaming, los precios son los siguientes.</div>
                    <h4 class="white fw-600 fs-m2 mt-10"></h4>
            ...
            <div class="w-100pc md-w-25pc">
                <div class="m-3 p-5 br-8 bg-indigo-lightest-10 overflow-hidden">
                    <div class="p-3">
                        <h3 class="indigo">Netflix &nbsp <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
width="18" height="18"
viewBox="0 0 30 30">
<path d="M24,4H6C4.895,4,4,4.895,4,6v18c0,1.105,0.895,2,2,2h18c1.105,0,2-0.895,2-2V6C26,4.895,25.105,4,24,4z M19,22	c0,0-1.5-0.232-3-0.232l-2-5.507v5.507c-1.5,0-3,0.232-3,0.232V8h3l2,5.6V8h3V22z"></path>
</svg></h3>
                        <div class="white flex items-center">$<span class="fs-l5 lh-1"> 139</span>/mo</div>
                    </div>
                    <div class="p-3 indigo-lightest fw-400 fs-s1 lh-5">
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">3 usuarios</span>
                        </div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">Contenido en HD</span></div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">Estrenos unicos</span></div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">24x7 soporte</span></div>
                        <div>
                            <i class="h-3" stroke-width="4" data-feather="x"></i>
                            <span class="opacity-50">Anuncios</span></div>
                    </div>
                    <div class="p-3">
                        <button class="button full bg-black white  hover-opacity-100 hover-scale-up-1 ease-300">Suscribirse</button>
                    </div>
                </div>
            </div>
            <div class="w-100pc md-w-25pc">
                <div class="m-3 p-5 br-8 bg-white overflow-hidden">
                    <div class="p-3">
                        <h3 class="indigo">Dazn &nbsp <img src="https://img.icons8.com/external-tal-revivo-shadow-tal-revivo/24/null/external-dazn-a-subscription-video-streaming-service-owned-by-perform-group-logo-shadow-tal-revivo.png"/></h3>
                        <div class="black flex items-center">$<span class="fs-l5 lh-1">$ 260</span>/mo</div>
                    </div>
                    ...
                    <div class="p-3">
                        <button class="button full bg-indigo white hover-opacity-100 hover-scale-up-1 ease-300">Suscribirse</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="slider-2">
            <div class="px-3">
                <div class="p-8 br-8 bg-indigo-lightest-10 relative">
                    ...
                    <p class="fw-600 fs-m1 indigo-lightest opacity-80 italic ls-wider">Spotify y Apple music</p>
                    <div class="flex items-center my-5">
                        <div class="block br-round border bc-black bw-4 w-l3 h-l3"><img class="br-round"
                                src="img/spos.png" alt=""></div>
            ...
            <div class="px-3">
                <div class="p-8 br-8 bg-indigo-lightest-10 relative">
                    <span class="fs-l5 lh-1 white opacity-10 absolute top-0 z--1">&#10077;</span>
                    <p class="fw-600 fs-m1 indigo-lightest opacity-80 italic ls-wider">Netflix</p>
                    <div class="flex items-center my-5">
                        <div class="block br-round border bc-black bw-4 w-l3 h-l3"><img class="br-round"
                                src="img/netflix.jpg" alt=""></div>
                        <div class="ml-4 fs-s1">
                            <div class="indigo-lightest">Mahnaz Farzin</div>
                            <div class="indigo-lightest opacity-20">Product Manager, XYZ</div>
                        </div>
            ...
            <div class="px-3">
                <div class="p-8 br-8 bg-indigo-lightest-10 relative">
                    <span class="fs-l5 lh-1 white opacity-10 absolute top-0 z--1">&#10077;</span>
                    <p class="fw-600 fs-m1 indigo-lightest opacity-80 italic ls-wider">HBO (HBO Max desde octubre de 2021)</p>
                    <div class="flex items-center my-5">
                        <div class="block br-round border bc-black bw-4 w-l3 h-l3"><img class="br-round"
                                src="img/HBO.jpeg" alt=""></div>
                        <div class="ml-4 fs-s1">
                            <div class="indigo-lightest">Mahnaz Farzin</div>
                            <div class="indigo-lightest opacity-20">Product Manager, XYZ</div>
                        </div>
            ...
            <div class="px-3">
                <div class="p-8 br-8 bg-indigo-lightest-10 relative">
                    <span class="fs-l5 lh-1 white opacity-10 absolute top-0 z--1">&#10077;</span>
                    <p class="fw-600 fs-m1 indigo-lightest opacity-80 italic ls-wider">Disney+</p>
                    <div class="flex items-center my-5">
                        <div class="block br-round border bc-black bw-4 w-l3 h-l3"><img class="br-round"
                                src="img/disney.jpeg" alt=""></div>
                        <div class="ml-4 fs-s1">
                            <div class="indigo-lightest">Mahnaz Farzin</div>
                            <div class="indigo-lightest opacity-20">Product Manager, XYZ</div>
                        </div>
            ...
            <div class="px-3">
                <div class="p-8 br-8 bg-indigo-lightest-10 relative">
                    <span class="fs-l5 lh-1 white opacity-10 absolute top-0 z--1">&#10077;</span>
                    <p class="fw-600 fs-m1 indigo-lightest opacity-80 italic ls-wider">Amazon Prime Video</p>
                    <div class="flex items-center my-5">
                        <div class="block br-round border bc-black bw-4 w-l3 h-l3"><img class="br-round"
                                src="img/prime.jpeg" alt=""></div>
                        <div class="ml-4 fs-s1">
                            <div class="indigo-lightest">Mahnaz Farzin</div>
                            <div class="indigo-lightest opacity-20">Product Manager, XYZ</div>
                        </div>
            ...
            <div class="px-3">
                <div class="p-8 br-8 bg-indigo-lightest-10 relative">
                    <span class="fs-l5 lh-1 white opacity-10 absolute top-0 z--1">&#10077;</span>
                    <p class="fw-600 fs-m1 indigo-lightest opacity-80 italic ls-wider">Filmin</p>
                    <div class="flex items-center my-5">
                        <div class="block br-round border bc-black bw-4 w-l3 h-l3"><img class="br-round"
                                src="img/filmin.webp" alt=""></div>
                        <div class="ml-4 fs-s1">
                            <div class="indigo-lightest">Mahnaz Farzin</div>
                            <div class="indigo-lightest opacity-20">Product Manager, XYZ</div>
                        </div>
    ...
    <footer class="p-5 md-p-l5 bg-indigo-lightest-10">
        <div class="flex flex-wrap">
            ...
            <div class="w-100pc md-w-25pc">
            </center><div class="flex w-75pc md-w-100pc mx-auto">
               <a href="comentarios.php"><button class="button bg-indigo indigo-lightest fw-300 fs-s3 br-l-0">Comentarios acerca del sitio</button></a>
                </div> </center>
